		...
		caches.open(version + 'fundamentals')
			.then(function (cache) {
				return cache.addAll([
					...
					'img/tonneau-tomber-droit/New Piskel-1.png',
					'img/tonneau-tomber-droit/New Piskel-2.png',
					'img/tonneau-tomber-droit/New Piskel-3.png',
					'img/tonneau-tomber-droit/New Piskel-4.png',
					'img/tonneau-tomber-droit/New Piskel-5.png',
					'img/tonneau-tomber-droit/New Piskel-6.png',
					'img/tonneau-tomber-droit/New Piskel-7.png',
					'img/tonneau-tomber-droit/New Piskel-8.png',
